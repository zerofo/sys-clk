...
echo "*** assets ***"
mkdir -p "$DIST_DIR/switch/config/sys-clk"
cp -vf "$ROOT_DIR/config.ini.template" "$DIST_DIR/switch/config/sys-clk/config.ini.template"
cp -vf "$ROOT_DIR/README.md" "$DIST_DIR/switch/config/sys-clk/README.md"
